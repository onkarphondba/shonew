...
public class CnvCustInfoEnrichedCreatePartitioner extends KeyBasedPartitioner {
	...
	public String getPrimaryKeyQuery() {
		...
		query.append(BatchConstants.CUSTCNVINFO_ENRICHED_CREATE_FROM_CLAUSE.replace(":correlationId", correlationId));
