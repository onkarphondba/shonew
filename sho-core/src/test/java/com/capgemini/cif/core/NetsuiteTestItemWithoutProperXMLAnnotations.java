...
public class NetsuiteTestItemWithoutProperXMLAnnotations implements Serializable, ConcreteProduct {

	private static final long serialVersionUID = -5646031438808104690L;
	private Long itemId;
	private String name;

	public NetsuiteTestItemWithoutProperXMLAnnotations() {
		super();
	}

	public NetsuiteTestItemWithoutProperXMLAnnotations(Long itemId, String name) {
		super();
		this.itemId = itemId;
		this.name = name;
	}
